...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-inxv0u4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-inxv0u4.containers.anotherwebservice.com/
...
```
git clone git@github.com:shahiroshan/container-inxv0u4.git
cd container-inxv0u4
```
...
```
docker attach container-inxv0u4
```
